...
1. Ainda é necessário estar conectado à VM Cliente 1 (SC-401-CL1) como a conta **SC-401-CL1\admin** e ao Microsoft Purview como Joni Sherman.

1. Selecione o Inicializador de aplicativos (o ícone de grade) no canto superior esquerdo e, em seguida, selecione **SharePoint** no submenu.

   ![Captura de tela mostrando onde as reticências devem ser exibidas para mostrar o menu de ação.](../Media/sharepoint-app-launcher.png)
